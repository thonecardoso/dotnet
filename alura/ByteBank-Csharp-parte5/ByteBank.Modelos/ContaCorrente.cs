...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente
    {
        ...
        /// </summary>
        /// <param name="agencia"> Representa o valor da propriedade <see cref="Agencia"/> e deve posssuir um valor maior que zero. </param>
        /// <param name="numero"> Representa o valor da propriedade <see cref="Numero"/> e deve posssuir um valor maior que zero. </param>
